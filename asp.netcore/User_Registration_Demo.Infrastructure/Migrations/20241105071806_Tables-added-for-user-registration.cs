...
{
    /// <inheritdoc />
    public partial class Tablesaddedforuserregistration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageDiscount = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Subscriptions",
                columns: new[] { "Id", "PackageCost", "PackageDiscount", "PackageType" },
                values: new object[,]
                {
                    { 1, 20.00m, 0m, 0 },
                    { 2, 20.00m, 20m, 1 }
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "FeatureName", "SubscriptionId" },
                values: new object[,]
                {
                    { 1, "Advance analytics", 2 },
                    { 2, "Mobile app access", 2 },
                    { 3, "Real-time updates and notifications", 2 },
                    { 4, "Up to 500 students", 2 },
                    { 5, "Multiple school branches", 2 },
                    { 6, "Advance analytics", 1 },
                    { 7, "Mobile app access", 1 }
                });
